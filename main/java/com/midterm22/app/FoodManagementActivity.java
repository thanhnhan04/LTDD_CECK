...
public class FoodManagementActivity extends AppCompatActivity {
    ...
    private ProductAdminAdapter currentAdapter, hiddenAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentAdapter = new ProductAdminAdapter(this, foodList);
        hiddenAdapter = new ProductAdminAdapter(this, foodList);
    ...
    private void setupAdapterActions() {
        ProductAdminAdapter.OnFoodActionListener actionListener = new ProductAdminAdapter.OnFoodActionListener() {
            @Override
